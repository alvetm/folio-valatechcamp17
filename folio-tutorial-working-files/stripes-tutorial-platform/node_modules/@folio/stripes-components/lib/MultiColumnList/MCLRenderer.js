...
import getNextFocusable from '@folio/stripes-components/util/getNextFocusable';
...
class MCLRenderer extends React.Component{
  constructor(props){
    ...
    this.keyMap = Object.assign({
      ...
      'backtick': '`',
      'tilde': '~',
    }, this.props.hotKeys.keyMap);

    this.handlers = Object.assign({
      'enter': this.handleEnterPress,
      'backtick': this.handleEscapePress,
      'tilde': this.focusBeyond,
  ...
  render(){
    const { firstIndex, amountToRender, columnWidths } = this.state;
    const { contentData, isEmptyMessage, rowMetadata, width } = this.props;
    ...
    for( let i = 0; i < amountToRender; i++){
      ...
      if(contentData[rowIndex]){
        ...
        const row = this.props.rowFormatter({rowIndex, rowClass, rowData: this.props.contentData[rowIndex], cells, rowProps, width,
    columnWidths,});
    ...
    return (
      <HotKeys keyMap={this.keyMap} handlers={this.handlers} noWrapper>
        <div 
